...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'Category', icon: 'bx bx-category', class: 'sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
            { path: '/AddCategory', title: 'Email', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        ]
    },
    ...
    },
    {
        ...
        submenu: [
            ...
            { path: '/content/coupon', title: 'Coupon', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
